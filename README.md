...
The console is a command line interpreter. It can be used to handle and manipulate all classes utilized by 
the application (achieved by calls on the `storage` object defined above).

### Using the Console

This console can be run both interactively and non-interactively as shown below:
...
The console has following commands defined:
...
(hbnb)
(hbnb) update User 6f348019-0499-420f-8eec-ef0fdc863c02 first_name "Nicanor"
(hbnb) show User 6f348019-0499-420f-8eec-ef0fdc863c02
[User] (6f348019-0499-420f-8eec-ef0fdc863c02) {'created_at': datetime.datetime(
2019, 2, 17, 21, 54, 39, 234382), 'first_name': 'Nicanor', 'updated_at': date
time.datetime(2019, 2, 17, 21, 54, 39, 234382), 'id': '6f348019-0499-420f-8eec-
ef0fdc863c02'}
(hbnb)
(hbnb) User.update(6f348019-0499-420f-8eec-ef0fdc863c02, address, "1010 Nairobi
Kenya")
(hbnb) User.show(6f348019-0499-420f-8eec-ef0fdc863c02)
[User] (6f348019-0499-420f-8eec-ef0fdc863c02) {'created_at': datetime.datetime(
2019, 2, 17, 21, 54, 39, 234382), 'address': '1010 Nairobi', 'first_name': 'Nicanor',
'updated_at': datetime.datetime(2019, 2, 17, 21, 54, 39, 234382), 'id
': '6f348019-0499-420f-8eec-ef0fdc863c02'}
(hbnb)
(hbnb) User.update(6f348019-0499-420f-8eec-ef0fdc863c02, {'email': 'airbnb@gmail.com',
'last_name': 'School'})[User] (6f348019-0499-420f-8eec-ef0fdc863c02) {'email': 'airbnb
@gmail.com', 'first_name': 'Nicanor', 'updated_at': datetime.datetime(2019, 2, 17, 21,
54, 39, 234382), 'address': '1010-Nairobi', 'last_name': 'School', 'id': '6f34
...
Unittests for the AirBnB project can be found in [tests](./tests) 
directory. To run the entire test suite , run the following command:
...
```
$ python3 unittest -m tests/test_models/test_models.py
```
